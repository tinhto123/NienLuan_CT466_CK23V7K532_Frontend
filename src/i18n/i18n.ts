...
const resources = {
  en: {
    translation: {
      ...
      confirm_approve_all: 'Are you sure you want to approve all pending orders?',
      confirm_approve_order: 'Are you sure you want to approve this order?',
      approve_all_success: 'All orders have been approved successfully!',
      approve_order_success: 'Order has been approved successfully!',
      approve_all_error: 'Failed to approve all orders',
      approve_order_error: 'Failed to approve order',
      confirm: 'Confirm',
      success: 'Success',
      error: 'Error',
      ok: 'OK'
  ...
  vi: {
    translation: {
      ...
      enter_price_before_discount: 'Nhập giá trước khi giảm...',
      enter_quantity: 'Nhập số lượng...',
      select_category: 'Chọn loại sản phẩm',
      prev_page: 'Trang trước',
      next_page: 'Trang sau',
      page: 'Trang',
      error_upload_image: 'Lỗi khi upload ảnh!',
      main_image_required: 'Vui lòng chọn ảnh chính cho sản phẩm!',
      update_product_success: 'Cập nhật sản phẩm thành công!',
      add_product_success: 'Thêm sản phẩm thành công!',
      error_submit: 'Có lỗi xảy ra!',
      delete_product_success: 'Xóa sản phẩm thành công!',
      error_delete: 'Có lỗi xảy ra khi xóa sản phẩm!',
      approve_all_orders: 'Duyệt tất cả đơn hàng',
      approve_order: 'Duyệt đơn hàng',
      confirm_approve_all: 'Bạn có chắc chắn muốn duyệt tất cả đơn hàng chờ duyệt không?',
      confirm_approve_order: 'Bạn có chắc chắn muốn duyệt đơn hàng này không?',
      approve_all_success: 'Đã duyệt tất cả đơn hàng thành công!',
